...
contract XBlockTrancheStratRefillTest is XBlockStratUtil {
    ...
    function testCalculateTrancheDelay() public {

        uint256[] memory stack0 = eval(
        ...
        console2.log("-------------------"); //3500000000000000000000 //1000000000000000000
        for(uint256 i = 0; i < stack0.length; i++){
            console2.log(stack0[i]);
        } 
        ...
        console2.log("-------------------"); //3500000000000000000000 //1000000000000000000
        for(uint256 i = 0; i < stack1.length; i++){
            console2.log(stack1[i]);
        } 
