...
library LibTrancheRefillOrders {
    ...
    function getTrancheRefillBuyOrder(Vm vm, address orderBookSubparser, address uniswapWords)
        internal
    ...
    function getTrancheRefillSellOrder(Vm vm, address orderBookSubparser, address uniswapWords)
        internal
        returns (bytes memory trancheRefill)
    {
        string[] memory ffi = new string[](43);
